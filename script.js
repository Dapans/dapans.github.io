...
if(ftganti==8){fotostiker.src = fotostiker9.src;fotostiker.style="display:inline-flex;opacity:1;transition:all .7s ease;transform:scale(1);";}
if(ftganti==9){fotostiker.src = fotostiker10.src;fotostiker.style="display:inline-flex;opacity:1;transition:all .7s ease;transform:scale(1);";}
if(ftganti==10){fotostiker.src = fotostiker11.src;fotostiker.style="display:inline-flex;opacity:1;transition:all .7s ease;transform:scale(1);";}
if(ftganti==11){fotostiker.src = fotostiker12.src;fotostiker.style="display:inline-flex;opacity:1;transition:all .7s ease;transform:scale(1);";}
if(ftganti==12){fotostiker.src = fotostiker13.src;fotostiker.style="display:inline-flex;opacity:1;transition:all .7s ease;transform:scale(1);";}
if(ftganti==13){fotostiker.src = fotostiker14.src;fotostiker.style="display:inline-flex;opacity:1;transition:all .7s ease;transform:scale(1);";}
}
...
if(opsLcheck==6){kalimat.innerHTML = kalimatg.innerHTML;otokal();fthilang();ftganti=6;setTimeout(ftmuncul,300);}
if(opsLcheck==7){kalimat.innerHTML = kalimath.innerHTML;otokal();fthilang();ftganti=7;setTimeout(ftmuncul,300);}
if(opsLcheck==8){kalimat.innerHTML = kalimati.innerHTML;otokal();fthilang();ftganti=8;setTimeout(ftmuncul,300);}
if(opsLcheck==9){kalimat.innerHTML = kalimatj.innerHTML;otokal();fthilang();ftganti=9;setTimeout(ftmuncul,300);}
if(opsLcheck==10){kalimat.innerHTML = kalimatk.innerHTML;otokal();fthilang();ftganti=10;setTimeout(ftmuncul,300);}
if(opsLcheck==11){kalimat.innerHTML = kalimatl.innerHTML;otokal();fthilang();ftganti=11;setTimeout(ftmuncul,300);}
if(opsLcheck==12){kalimat.innerHTML = kalimatm.innerHTML;otokal();fthilang();ftganti=12;setTimeout(ftmuncul,300);}
if(opsLcheck==13){kethalo2();}
